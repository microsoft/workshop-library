...
1️⃣ | [Explore and Analyze Data with R](./full/explore-analyze-data-R/README.md) | Carlotta Casteluccio and Eric Wanjau | 2 hours | Clean and explore data with R | [🎥](https://youtu.be/VrVHaxarniY) | data, R, Tidyverse |
...
2️⃣ | [Introduction to Regression Models with R and Tidymodels](./full/intro-regression-R-tidymodels/README.md) | Carlotta Casteluccio and Eric Wanjau | 2 hours | Using R, learn about Regression Models with Tidymodels |  [🎥](https://youtu.be/ckqijBKO-Es) | Regression, Tidymodels, Tidyverse, R |
