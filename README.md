...
1️⃣ | [Integrating Custom Vision with Power Apps for Diabetic Retinopathy Detection](./full/Integrate-Custom-Vision-with-Power-App/README.md) | Jingyi Zhu, Sanya Sinha | 1 hour  | Build a no-code App using Power Platform |[🎥](https://youtu.be/NLXtRjXgMBo) | Power Apps, Power Platform, [Canvas apps](https://docs.microsoft.com/learn/modules/build-app-solution/?WT.mc_id=academic-56577-hmitra) |
