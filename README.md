...
1️⃣ | [Explore and Analyze Data with R](./full/explore-analyze-data-R/README.md) | Carlotta Casteluccio and [Eric Wanjau](https://twitter.com/ericntay) | 2 hours | Clean and explore data with R | [🎥](https://youtu.be/VrVHaxarniY) | data, R, Tidyverse |
