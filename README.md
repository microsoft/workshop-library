...
2️⃣ | [Build your Resume Website with .NET](./full/build-resume-website-dotnet/) | Katie Savage | 1 hour | Create and customize your own Resume Website using Microsoft's .NET Blazor | [🎥](https://aka.ms/studentzone-blazor) | .NET, Blazor, Azure |
2️⃣ | [Track your Water Consumption with .NET IoT](./full/track-water-consumption-iot-dotnet/) | Katie Savage | 1 hour | Create an IoT project that will track your water consumption using weight sensors and an accelerometer | [🎥](https://aka.ms/studentzone-iot) | .NET, IoT, Azure |
